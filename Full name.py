...
"""
a = 'Евлампьев Василий Николаевич'
""" Задание №1
...
print('№1 ' + str(fio == ['Короткий', 'Дмитрий', 'Евгеньевич']))
...
"""------------ конец блока редактирования----------------"""
print('№7 ' + str(surname_list == ['К', 'о', 'р', 'о', 'т', 'к', 'и', 'й']))
...
"""------------ конец блока редактирования----------------"""
print('№8 ' + str(surname_tuple == ('К', 'о', 'р', 'о', 'т', 'к', 'и', 'й')))
...
"""------------ конец блока редактирования----------------"""
print('№10 ' + str(res == [(0, 'К'), (1, 'о'), (2, 'р'), (3, 'о'), (4, 'т'), (5, 'к'), (6, 'и'), (7, 'й')]))
...
"""------------ конец блока редактирования----------------"""
print('№11 ' + str(res == ['й', 'и', 'к', 'т', 'о', 'р', 'о', 'К']))
...
"""------------ конец блока редактирования----------------"""
print('№13 ' + str(res == ['Е', 'в', 'а', 'м', 'п', 'ь', 'е', 'в']))